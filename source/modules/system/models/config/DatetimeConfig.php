...
class DatetimeConfig extends ConfigForm
{
    ...
    public static function getTimezones($v = NULL) {
        $ret = [
    ...
    public $datetime_date_format = 'yyyy-mm-dd';
    public $datetime_time_format;
    public $datetime_pretty_format = '1';


    public function rules() {
        return [
            [['datetime_timezone', 'datetime_date_format', 'datetime_time_format'], 'string'],
            [['datetime_pretty_format'], 'boolean'],
        ];
    }
    ...
    public function attributeLabels() {
        return [
            ...
            'datetime_pretty_format' => '人性化时间格式',
        ];
    }
