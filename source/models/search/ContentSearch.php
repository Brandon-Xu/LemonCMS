...
class ContentSearch extends Content
{
    ...
    public function rules() {
        return [
            [
                [
                    'id', 'taxonomy_id', 'user_id', 'last_user_id', 'created_at', 'updated_at', 'focus_count',
    ...
    public function search($params) {
        ...
        $query->andFilterWhere(['like', 'user_name', $this->user_name])->andFilterWhere([
            'like', 'last_user_name', $this->last_user_name,
        ])->andFilterWhere([
            'like', 'password', $this->password,
        ])//->andFilterWhere(['like', 'template', $this->template])
        ->andFilterWhere(['like', 'content_type', $this->content_type])->andFilterWhere([
            'like', 'seo_title', $this->seo_title,
        ])->andFilterWhere(['like', 'seo_keywords', $this->seo_keywords])->andFilterWhere([
            'like', 'seo_description', $this->seo_description,
        ])->andFilterWhere(['like', 'title', $this->title])->andFilterWhere(['like', 'summary', $this->summary])
            ->andFilterWhere(['like', 'thumb', $this->thumb])->andFilterWhere(['like', 'url_alias', $this->url_alias]);
