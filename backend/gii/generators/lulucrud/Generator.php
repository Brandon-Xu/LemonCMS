...
namespace backend\gii\generators\lulucrud;
...
{
    private $moduleDir = 'module dir';

    public $modelClass = 'source\modules\module dir\models\\';
    public $searchModelClass = 'source\modules\module dir\models\search\\';

    public $controllerClass = 'source\modules\module dir\admin\controllers\\';
    public $viewPath = '@source/modules/module dir/admin/views/';
    public $baseControllerClass = 'source\core\back\BackController';
    ...
    public function init() {
        ...
        $this->modelClass = 'source\modules\\'.$this->moduleDir.'\models\\';
        $this->searchModelClass = 'source\modules\\'.$this->moduleDir.'\models\search\\';
        $this->controllerClass = 'source\modules\\'.$this->moduleDir.'\admin\controllers\controller id Controller';
        $this->viewPath = '@source/modules/'.$this->moduleDir.'/admin/views/';
    }
    ...
    public function attributeLabels() {
        return array_merge(parent::attributeLabels(), [
            'modelClass' => 'Model Class', 'controllerClass' => 'Controller Class', 'viewPath' => 'View Path',
            'baseControllerClass' => 'Base Controller Class', 'indexWidgetType' => 'Widget Used in Index Page',
    ...
    public function hints() {
        return array_merge(parent::hints(), [
            'modelClass' => 'This is the ActiveRecord class associated with the table that CRUD will be built upon.
                You should provide a fully qualified class name, e.g., <code>source\models\Post</code>.',
            ...
            'indexWidgetType' => 'This is the widget type to be used in the index page to display list of the models.
                ...
                qualified namespaced class name, e.g., <code>source\models\PostSearch</code>.',
        ]);
    }
    ...
    public function generateColumnFormat($column) {
        if ($column->phpType === 'boolean') {
            ...
            return 'datetime';
        } else if (stripos($column->name, 'email') !== FALSE) {
            return 'email';
        } else if (stripos($column->name, 'url') !== FALSE) {
            return 'url';
        } else {
            return 'text';
        }
