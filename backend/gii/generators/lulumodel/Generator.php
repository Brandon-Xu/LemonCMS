...
namespace backend\gii\generators\lulumodel;
...
class Generator extends \yii\gii\Generator
{
    ...
    public $db = 'db';
    public $ns = 'source\modules\xxx\models';
    public $tableName;
    public $modelClass;
    public $baseClass = 'source\core\base\BaseActiveRecord';
    ...
    public function init() {
        ...
        $this->ns = 'source\modules\\'.$this->moduleDir.'\models';
    }

    public function getModuleDir() {
        $moduleDir = 'module dir';

        $className = \backend\gii\generators\lulumodule\Generator::className();

        $path = Yii::$app->getRuntimePath().'/gii-'.Yii::getVersion().'/'.str_replace('\\', '-', $className).'.json';
        //var_dump($path);
    ...
    public function rules() {
        return array_merge(parent::rules(), [
            ...
            ], [['db'], 'validateDb'], [['ns', 'queryNs'], 'validateNamespace'], [['tableName'], 'validateTableName'],
            [['modelClass'], 'validateModelClass', 'skipOnEmpty' => FALSE],
            [['baseClass'], 'validateClass', 'params' => ['extends' => ActiveRecord::className()]],
            [['queryBaseClass'], 'validateClass', 'params' => ['extends' => ActiveQuery::className()]], [
                ['generateRelations', 'generateLabelsFromComments', 'useTablePrefix', 'useSchemaName', 'generateQuery'],
                'boolean'
    ...
    public function attributeLabels() {
        return array_merge(parent::attributeLabels(), [
            'ns' => 'Namespace', 'db' => 'Database Connection ID', 'tableName' => 'Table Name',
            'modelClass' => 'Model Class', 'baseClass' => 'Base Class', 'generateRelations' => 'Generate Relations',
            'generateLabelsFromComments' => 'Generate Labels from DB Comments',
            'generateQuery' => 'Generate ActiveQuery', 'queryNs' => 'ActiveQuery Namespace',
            'queryClass' => 'ActiveQuery Class', 'queryBaseClass' => 'ActiveQuery Base Class',
        ]);
    }
    ...
    public function hints() {
        return array_merge(parent::hints(), [
            ...
            'db' => 'This is the ID of the DB application component.', 'tableName' => 'This is the name of the DB table that the new ActiveRecord class is associated with, e.g. <code>post</code>.
    ...
    public function stickyAttributes() {
        return array_merge(parent::stickyAttributes(), [
            'db', 'baseClass', 'generateRelations', 'generateLabelsFromComments', 'queryNs', 'queryBaseClass'
        ]);
    }
    ...
    public function generate() {
        ...
        foreach ($this->getTableNames() as $tableName) {
            ...
            $params = [
                'tableName' => $tableName, 'className' => $modelClassName, 'queryClassName' => $queryClassName,
                'tableSchema' => $tableSchema, 'labels' => $this->generateLabels($tableSchema),
            ...
            if ($queryClassName) {
                $params = [
                    'className' => $queryClassName, 'modelClassName' => $modelClassName,
                ];
            ...
            foreach ($db->getSchema()->getTableSchemas($schemaName) as $table) {
                ...
                foreach ($table->foreignKeys as $refs) {
                    ...
                    $relations[ $table->fullName ][ $relationName ] = [
                        "return \$this->hasOne($refClassName::className(), $link);", $refClassName, FALSE,
                    ];
