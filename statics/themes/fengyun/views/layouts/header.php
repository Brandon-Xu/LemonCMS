...
<head>
    ...
    <link rel='stylesheet' id='themememe-icons-css'
          href='<?php echo $this->getThemeUrl() ?>/css/fonts/font-awesome.min.css?ver=1419744126' type='text/css'
          media='all'/>

    <script type='text/javascript' src='<?php echo $this->getThemeUrl() ?>/js/jquery.min.js?ver=1419744126'></script>
    <script type='text/javascript'
            src='<?php echo $this->getThemeUrl() ?>/js/jquery-migrate.min.js?ver=1419744126'></script>
    <script type='text/javascript'
            src='<?php echo $this->getThemeUrl() ?>/js/jquery.dropkick.min.js?ver=1419744126'></script>
